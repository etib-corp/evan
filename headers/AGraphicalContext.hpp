...
public:
  ...
  /**
   * @brief Retrieves the list of required instance extensions for the graphical
   * context.
   *
   * This pure virtual function must be implemented by derived classes to
   * provide a list of Vulkan instance extensions that are necessary for the
   * graphical context to function correctly. These extensions may include
   * platform-specific surface extensions or other features required by the
   * application.
   *
   * @return A vector of strings representing the names of the required instance
   * extensions.
   */
...
protected:
  ...
  std::shared_ptr<ASwapchainContext>
      _swapchainContext; // Swapchain context for managing swapchain-related
                         // resources
