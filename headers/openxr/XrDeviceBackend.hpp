...
namespace evan
{
	class XrDeviceBackend: public ADeviceBackend
	{
		...
		XrInstance
			_XrInstance = XR_NULL_HANDLE;	/// The OpenXR instance, which represents the
		...
		XrSystemId _systemId = XR_NULL_SYSTEM_ID;	 /// The OpenXR system ID, which represents the
		...
		XrSession
			_session = XR_NULL_HANDLE;	 /// The OpenXR session, which represents an active
