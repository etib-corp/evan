...
namespace evan {
     ...
     * Desktop. It handles platform-specific functionality related to Desktop using GLFW for window management and event handling.
     */
    class DesktopPlatform : public IPlatform {
        public:
             ...
             *
             * @return A vector of strings representing the required instance extensions for the Desktop platform.
             *
             * This method retrieves the necessary Vulkan instance extensions required for the Desktop platform, which may include extensions for window surface creation and other platform-specific features.
             */
             ...
             *
             * This method processes events for the Desktop platform, such as user input and window events, using the provided device backend. It ensures that the application remains responsive to user interactions and system events.
             *
             * Note: The implementation of this method may involve using GLFW's event polling functions to handle events specific to the Desktop platform.
             */
