...
namespace evan {
    ...
    class Frame {
         ...
         *
         * This constructor initializes the synchronization objects and command buffer
         * for the frame. It takes a command pool and a reference to the device backend
         * to set up the necessary Vulkan resources for rendering.
         *
         * @param commandPool The Vulkan command pool used to allocate command buffers for this frame.
         * @param deviceBackend A reference to the device backend that provides access to Vulkan resources and
         * functions needed to create synchronization objects and uniform buffers.
         */
         ...
         *
         * This function cleans up the synchronization objects, command buffer, and uniform buffer
         * associated with this frame. It should be called when the frame is no longer needed to free up Vulkan resources.
         *
         * @param device The Vulkan logical device used to destroy the resources.
         */
         ...
         *
         * This function resets the command buffer to the initial state, allowing it to be recorded again for the next frame.
         * It should be called at the beginning of each frame before recording commands.
         */
         ...
         *
         * This function returns the command buffer that is used for recording rendering commands
         * for this frame. It can be used to begin command buffer recording and submit commands to the graphics queue.
         */
        VkBuffer getUniformBuffer() const;

        /**
         * Fence to ensure that the frame is not rendered until the previous frame has finished.
         */
        VkFence _inFlight;
        ...
        /**
         * Semaphore to signal when rendering is finished and the image can be presented.
         */
         ...
         *
         * This function creates the Vulkan synchronization objects (fences and semaphores)
         * needed for rendering this frame, such as the in-flight fence,
         * image available semaphore, and render finished semaphore.
         */
         ...
         * It sets up the buffer to be used for passing data to the vertex shader during rendering.
         */
        void createUniformBuffer(const ADeviceBackend &deviceBackend);

        /**
         * @brief Vulkan buffer for the uniform buffer object (UBO) used in this frame.
         *
         * This buffer is allocated to store the model, view, and projection matrices
         * that will be passed to the vertex shader as a uniform buffer during rendering.
         */
         ...
         *
         * This memory is allocated to back the uniform buffer and is used to store the data for the UBO.
         * It is mapped to allow CPU access for updating the UBO data before rendering.
         */
