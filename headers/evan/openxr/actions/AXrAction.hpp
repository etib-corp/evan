...
namespace evan
{
											 ...
											 utility::logging::DefaultLogger>
	{
		 ...
		 * @brief Encapsulates properties required for creating an OpenXR
		 * action.
		 *
		 ...
		 */
		struct PropertiesXrActions {
			/** @brief The name of the action, used for identification and
			 * debugging purposes. It should be unique within the action set.
			 */
			std::string actionName;
			/** @brief The binding path for the action, specifying how the
			 * action is bound to input devices. This path should follow
			 * OpenXR's binding syntax and conventions.
			 */
			std::string bindingPath;
			/** @brief The action set to which this action belongs. An action
			 * set is a collection of actions that can be activated or
			 * deactivated together, allowing for better organization and
			 * management of actions in an OpenXR application.
			 */
		...
		/** @brief Destructor for AXrAction, responsible for cleaning up OpenXR
		 * resources.
		 *
		 * This destructor ensures that the XrAction handle is properly
		 * destroyed when the AXrAction object goes out of scope. It also checks
		 * if the associated action space is valid and destroys it if necessary,
		 * ensuring that all OpenXR resources are released correctly to prevent
		 ...
		 * identification and debugging purposes. The name should be unique
		 * within the action set to avoid conflicts with other actions.
		 *
		 ...
		 * creation fails, it throws a runtime error with details about the
		 * failure.
		 *
		 * @param properties A structure containing all necessary parameters for
		 * creating an OpenXR action.
		 *
		 * @throws std::runtime_error If action creation fails, providing
		...
		/** @brief The subaction path for the action, specifying the input
		 * source or device associated with the action. */
		...
		/** @brief The binding path for the action, specifying how the action is
		 * bound to input devices. */
