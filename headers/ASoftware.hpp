...
namespace evan
{
	 ...
	 * evan namespace.
	 *
	 * This class provides a common interface for software applications,
	 * including access to graphical context and versioning information for both
	 * the application and its engine.
	 */
	class ASoftware
	{
		public:
		 ...
		 * application.
		 *
		 * This function returns a shared pointer to an AGraphicalContext
		 * instance, which represents the graphical context used by the
		 * application.
		 *
		...
		std::shared_ptr<AGraphicalContext>
			_graphicalContext;	  // Graphical context
	};
}	 // namespace evan
